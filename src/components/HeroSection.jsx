    ...
    <>
      <section className="relative bg-black overflow-hidden py-16 px-4 pt-40">
        <div
          ...
          style={{ background: "rgba(255, 135, 0, 0.3)" }}
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center px-4 pt-20 pb-20">
            ...
            <p className="text-lg text-gray-200 max-w-xl mb-5">
              AI-Powered Browser Integrations That Save You Time, Eliminates
          ...
          <div className="relative px-4 pb-10 flex justify-center">
            <div className="relative w-full max-w-4xl">
              <div className="absolute inset-0 bg-[#F49F1C] opacity-20 blur-3xl rounded-lg transform translate-y-4 translate-x-4" />
